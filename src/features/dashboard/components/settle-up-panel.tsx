...
import { SettleUpConfirmDialog } from '@/features/settlements/components/settle-up-confirm-dialog';
        ...
        {balances.map((balance) => (
          ...
          >
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              {balance.groupId && (
                <SettleUpConfirmDialog balance={balance} currentUserId={currentUserId} />
              )}
            </div>
          </div>
        ))}
